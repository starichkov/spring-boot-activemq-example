 ...
 */
@Configuration
public class SenderConfigurationJMS extends MessagingConfiguration {
    private static final Logger LOGGER = LoggerFactory.getLogger(SenderConfigurationJMS.class);
